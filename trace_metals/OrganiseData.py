...
d['final_lon'] = df.final_lon[bool_sout]
d['final_lat'] = df.final_lat[bool_sout]
...
d['final_lon'] = df.final_lon[bool_nort]
d['final_lat'] = df.final_lat[bool_nort]
...
d['final_lon'] = df.final_lon[bool_offs]
d['final_lat'] = df.final_lat[bool_offs]
...
d['final_lon'] = df.final_lon[bool_loop]
d['final_lat'] = df.final_lat[bool_loop]
